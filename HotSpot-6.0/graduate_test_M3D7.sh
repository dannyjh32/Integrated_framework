...
#	./hotspot -c ${config_dir}/config/${BENCHMARK[$[bench_i]]}/${BENCHMARK[$[bench_i]]}_vapor_act.config -f G_HBM_BASE.flp -p ${output_dir2}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}/av_${best}.ptrace -model_type grid -grid_layer_file G8M3D_HBM.lcf -detailed_3D on -steady_file ${output_dir2}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}/av_${best}.steady
#	./hotspot -c ${config_dir}/config/${BENCHMARK[$[bench_i]]}/${BENCHMARK[$[bench_i]]}_vapor_act.config -f G_HBM_BASE.flp -p ${output_dir2}/${FREQ2[$[freq_i]]}/${BENCHMARK[$[bench_i]]}/av_${worst}.ptrace -model_type grid -grid_layer_file G8M3D_HBM.lcf -detailed_3D on -steady_file ${output_dir2}/${FREQ2[$[freq_i]]}/${BENCHMARK[$[bench_i]]}/av_${worst}.steady
