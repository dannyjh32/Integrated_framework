...
awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i]]}" 'NR==30{ print a, b,"1", $2 >> "graduate_correct/temp_result_heon_M3D_Best.txt" }' ${output_dir}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${best}.steady
...
awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i]]}" 'NR==164{ print a, b,"2", $2 >> "graduate_correct/temp_result_heon_M3D_Best.txt" }' ${output_dir}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${best}.steady
...
awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i]]}" 'NR==302{ print a, b,"3", $2 >> "graduate_correct/temp_result_heon_M3D_Best.txt" }' ${output_dir}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${best}.steady
...
awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i2]]}" 'NR==30{ print a, b,"1", $2 >> "graduate_correct/temp_result_heon_M3D_Worst.txt" }' ${output_dir}/${FREQ[$[freq_i2]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${worst}.steady
awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i2]]}" 'NR==30{ printf "%.0f", ($2)/10 >> "graduate_correct/temp_result_heon_M3D_Worst.txt" }' ${output_dir}/${FREQ[$[freq_i2]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${worst}.steady
echo '0' >> "graduate_correct/temp_result_heon_M3D_Worst.txt" 


awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i2]]}" 'NR==164{ print a, b,"2", $2 >> "graduate_correct/temp_result_heon_M3D_Worst.txt" }' ${output_dir}/${FREQ[$[freq_i2]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${worst}.steady
awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i2]]}" 'NR==164{ printf "%.0f", ($2)/10 >> "graduate_correct/temp_result_heon_M3D_Worst.txt" }' ${output_dir}/${FREQ[$[freq_i2]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${worst}.steady
echo '0' >> "graduate_correct/temp_result_heon_M3D_Worst.txt" 


awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i2]]}" 'NR==302{ print a, b,"3", $2 >> "graduate_correct/temp_result_heon_M3D_Worst.txt" }' ${output_dir}/${FREQ[$[freq_i2]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${worst}.steady
awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i2]]}" 'NR==302{ printf "%.0f", ($2)/10 >> "graduate_correct/temp_result_heon_M3D_Worst.txt" }' ${output_dir}/${FREQ[$[freq_i2]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${worst}.steady
echo '0' >> "graduate_correct/temp_result_heon_M3D_Worst.txt" 
...
awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i3]]}" 'NR==30{ print a, b,"1", $2 >> "graduate_correct/temp_result_heon_TSV.txt" }' ${output_dir}/${FREQ[$[freq_i3]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${tsv}.steady
awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i3]]}" 'NR==30{ printf "%.0f", ($2)/10 >> "graduate_correct/temp_result_heon_TSV.txt" }' ${output_dir}/${FREQ[$[freq_i3]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${tsv}.steady
echo '0' >> "graduate_correct/temp_result_heon_TSV.txt" 


awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i3]]}" 'NR==164{ print a, b,"2", $2 >> "graduate_correct/temp_result_heon_TSV.txt" }' ${output_dir}/${FREQ[$[freq_i3]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${tsv}.steady
awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i3]]}" 'NR==164{ printf "%.0f", ($2)/10 >> "graduate_correct/temp_result_heon_TSV.txt" }' ${output_dir}/${FREQ[$[freq_i3]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${tsv}.steady
echo '0' >> "graduate_correct/temp_result_heon_TSV.txt" 


awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i3]]}" 'NR==302{ print a, b,"3", $2 >> "graduate_correct/temp_result_heon_TSV.txt" }' ${output_dir}/${FREQ[$[freq_i3]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${tsv}.steady
awk -v a="${BENCHMARK[$[bench_i]]}" -v b="${cooling[$[cooling_i]]}" -v c="${FREQ[$[freq_i3]]}" 'NR==302{ printf "%.0f", ($2)/10 >> "graduate_correct/temp_result_heon_TSV.txt" }' ${output_dir}/${FREQ[$[freq_i3]]}/${BENCHMARK[$[bench_i]]}/${cooling[$[cooling_i]]}_${tsv}.steady
echo '0' >> "graduate_correct/temp_result_heon_TSV.txt" 
