...
FREQ3=3.8GHz
bench_i=0
	./hotspot -c ${config_dir}/config/${BENCHMARK[$[bench_i]]}/${BENCHMARK[$[bench_i]]}_l.config -f G_HBM_BASE.flp -p ${output_dir2}/${FREQ3[$[freq_i]]}/${BENCHMARK[$[bench_i]]}/l_${tsv}.ptrace -model_type grid -grid_layer_file G8TSV_HBM.lcf -detailed_3D on -steady_file ${output_dir2}/${FREQ3[$[freq_i]]}/${BENCHMARK[$[bench_i]]}/l_${tsv}.steady
