...
# We Need This For 3D_3L (thermal)
		./hotspot -c ${config_dir}/config/${BENCHMARK[$[bench_i]]}/${BENCHMARK[$[bench_i]]}_aa.config -f D_2D_CPU.flp -p ${output_dir}/${FREQ}/${BENCHMARK[$[bench_i]]}/INDIUM_aa_TSV-3D_2L_Thermal.ptrace -steady_file ${output_dir}/${FREQ}/${BENCHMARK[$[bench_i]]}/INDIUM_cpu_aa_3D_2L_${BENCHMARK[$[bench_i]]}_${FREQ}_Thermal.steady -model_type grid -grid_layer_file D_3D_CPU_2L_INDIUM.lcf
