...
#FREQ=4GHz
FREQ=("3.4GHz" "3.5GHz" "3.9GHz" "4.2GHz" "5GHz" "5.3GHz" "5.4GHz" "3.9GHz" "4.1GHz" "4.2GHz" "4.6GHz" "4.9GHz" "5GHz" "5.3GHz" "5.4GHz")
...
python ${Parser_home}/Gem5ToMcPAT-Parser.py -c ${gem5_dir}/${FREQ[$[freq_i]]}/config.json -s ${gem5_dir3}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/stats.txt -t ${template_dir}/template_${FREQ[$[freq_i]]}_${TEMP[$[temp_i]]}.xml -o ${gem5_dir2}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/mcpat_input_${BENCHMARK[$[bench_i]]}_${TEMP[$[temp_i]]}.xml
...
#	$McPat_home/mcpat -infile ${gem5_dir2}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/mcpat_input_${BENCHMARK[$[bench_i]]}_${TEMP[$[temp_i]]}.xml -print_level 5 -opt_for_clk 1 >  $gem5_dir2/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/power_${TEMP[$[temp_i]]}_${BENCHMARK[$[bench_i]]}_aa_FirstLoop.txt
	$McPat_home/mcpat -infile ${gem5_dir2}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/mcpat_input_${BENCHMARK[$[bench_i]]}_${TEMP[$[temp_i]]}.xml -print_level 5 -opt_for_clk 1 >  $gem5_dir2/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/power_${BENCHMARK[$[bench_i]]}_aa_FirstLoop_${TEMP[$[temp_i]]}.txt
