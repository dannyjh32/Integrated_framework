...
#For Thermal Ex
	...
	do
		python ${PowerTrace_File}/PowerTrace_2D.py ${gem5_dir}/${FREQ}/${BENCHMARK[$[bench_i]]}_${FREQ}/ScaledPower_2D_${BENCHMARK[$[bench_i]]}_${COOLING[$[cooling_i]]}_FirstLoop_heon.txt ${HotSpot_dir}/${FREQ}/${BENCHMARK[$[bench_i]]}/single_${COOLING[$[cooling_i]]}_2D_heon.ptrace
