...
#For 2D
	...
	do
	python ${Scaling_File_2D} ${gem5_dir}/${FREQ}/${BENCHMARK_1[$[bench_i]]}_${FREQ}/power_${BENCHMARK_1[$[bench_i]]}_${COOLING[$[cooling_i]]}_FirstLoop_aggressive.txt ${gem5_dir}/${FREQ}/${BENCHMARK_1[$[bench_i]]}_${FREQ}/ScaledPower_2D_${BENCHMARK_1[$[bench_i]]}_${COOLING[$[cooling_i]]}_FirstLoop_aggressive.txt ${SCALING_FACTOR_1[$[bench_i]]} $PCIE_SCALING_1
...
#For 2D
	...
	while [ ${cooling_i} -ne 4 ]
	do
	python ${Scaling_File_2D} ${gem5_dir}/${FREQ}/${BENCHMARK_2[$[bench_i]]}_${FREQ}/power_${BENCHMARK_2[$[bench_i]]}_${COOLING[$[cooling_i]]}_FirstLoop_aggressive.txt ${gem5_dir}/${FREQ}/${BENCHMARK_2[$[bench_i]]}_${FREQ}/ScaledPower_2D_${BENCHMARK_2[$[bench_i]]}_${COOLING[$[cooling_i]]}_FirstLoop_aggressive.txt ${SCALING_FACTOR_2[$[bench_i]]} $PCIE_SCALING_2
	cooling_i=$((cooling_i+1))
