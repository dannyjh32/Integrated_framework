...
#FREQ=4GHz
FREQ=("4.4GHz" "4.5GHz" "5GHz" "5.1GHz" "5.2GHz" "5.3GHz")
FREQ2=("3.8GHz")
...
while [ ${freq_i} -ne 6 ] #15
do

while [ ${bench_i} -ne 1 ] #7
do
...
#For Others
python ${Parser_home}/Gem5ToMcPAT-Parser.py -c ${gem5_dir}/${FREQ[$[freq_i]]}/config.json -s ${gem5_dir3}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/stats.txt -t ${M3D_template_dir}/template_${FREQ[$[freq_i]]}_aggressive_${TEMP}.xml -o ${gem5_dir2}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/mcpat_input_${BENCHMARK[$[bench_i]]}_aggressive_${TEMP}.xml
...
python ${Parser_home}/Gem5ToMcPAT-Parser.py -c ${gem5_dir}/${FREQ[$[freq_i]]}/config.json -s ${gem5_dir3}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/stats.txt -t ${template_dir}/template_${FREQ[$[freq_i]]}_${TEMP}.xml -o ${gem5_dir2}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/mcpat_input_${BENCHMARK[$[bench_i]]}_${TEMP}.xml
...
#	$McPat_home/mcpat -infile ${gem5_dir2}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/mcpat_input_${BENCHMARK[$[bench_i]]}_${TEMP[$[temp_i]]}.xml -print_level 5 -opt_for_clk 1 >  $gem5_dir2/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/power_${TEMP[$[temp_i]]}_${BENCHMARK[$[bench_i]]}_aa_FirstLoop.txt
	$McPat_home/mcpat -infile ${gem5_dir2}/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/mcpat_input_${BENCHMARK[$[bench_i]]}_${TEMP}.xml -print_level 5 -opt_for_clk 1 >  $gem5_dir2/${FREQ[$[freq_i]]}/${BENCHMARK[$[bench_i]]}_${FREQ[$[freq_i]]}/power_${BENCHMARK[$[bench_i]]}_aa_FirstLoop.txt
