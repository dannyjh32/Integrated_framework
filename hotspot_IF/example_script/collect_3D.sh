...
rm ${hot_base}/example_script/temp_result_M3D_Worst.txt
rm ${hot_base}/example_script/temp_result_M3D_Best.txt
rm ${hot_base}/example_script/temp_result_TSV.txt
...
sed -i 's/n/m/g' temp_result_TSV.txt
